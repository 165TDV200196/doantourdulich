                    ...
                    <div class="content-box">
                        ...
                        <div class="text">
                            ...
                            <table border="1">
                                ...
                                $sql = "select t.matour,dd.image,t.Tentour,dd.Tendiadiem,dd.Loaidiadiem from tour t join diadiem dd on t.Madiadiem=dd.Madiadiem where maloaitour=1";
                                ...
                                <tr>
                                    ...
                                    <td id="center"><a href="themtour.php?id=<?php echo $row['matour'] ?>">Sửa</a>
                                    </td>
                                    <td id="center"><a href="xoatour.php?id=<?php echo $row['matour'] ?>&hi=1">Xóa</a>
                                    </td>
                                </tr>
                                <?php
                                }
